...
kaggle = pd.DataFrame({'PassengerId': passengerId, 'Survived': predicted})
# save to csv
kaggle.to_csv(r'C:\Users\Student\Python Codes\Titanic Project\titanic_pred_svm_lin1.1.csv', index=False)
